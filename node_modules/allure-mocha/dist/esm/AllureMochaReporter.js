...
import { getFallbackTestCaseIdLabel, getHostLabel, getProjectName, getRelativePath, getThreadLabel } from "allure-js-commons/sdk/reporter";
...
import { applyTestPlan, createTestPlanIndices, getAllureDisplayName, getAllureFullName, getAllureMetaLabels, getAllureMetaLinks, getHookType, getLegacyTestCaseId, getSuitesOfMochaTest, getTestCaseId, getTestScope, isIncludedInTestRun, resolveParallelModeSetupFile, setTestScope } from "./utils.js";
var {
  EVENT_SUITE_BEGIN,
  EVENT_SUITE_END,
  EVENT_TEST_BEGIN,
  ...
  constructor(runner, _opts) {
    ...
    _defineProperty(this, "applyRuntimeMessages", function () {
      ...
      if (root) {
        ...
        _this.runtime.applyGlobalRuntimeMessages(message);
      }
    });
    /**
    ...
    _defineProperty(this, "onTestEnd", test => {
      ...
      if (isIncludedInTestRun(test)) {
        ...
        this.runtime.updateTest(this.currentTest, t => {
          ...
          var fsPath = getRelativePath(test.file).split(sep).filter(Boolean);
          ensureSuiteLabels(t, defaultSuites);
          var titlePath = fsPath.concat(...defaultSuites);
