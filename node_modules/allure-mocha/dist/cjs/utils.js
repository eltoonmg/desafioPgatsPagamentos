...
exports.setTestScope = exports.resolveParallelModeSetupFile = exports.isIncludedInTestRun = exports.getTestScope = exports.getTestCaseId = exports.getSuitesOfMochaTest = exports.getLegacyTestCaseId = exports.getHookType = exports.getAllureMetaLinks = exports.getAllureMetaLabels = exports.getAllureId = exports.getAllureFullName = exports.getAllureDisplayName = exports.createTestPlanIndices = exports.applyTestPlan = void 0;
...
var createAllureFullName = test => {
  ...
  var fullNameBase = test.file ? "".concat((0, _reporter.getPosixPath)((0, _reporter.getRelativePath)(test.file)), ": ").concat(titlePath) : titlePath;
  return projectName ? "".concat(projectName, ":").concat(fullNameBase) : fullNameBase;
};
...
var getTestCaseId = test => {
  ...
  var testFileId = projectName ? "".concat(projectName, ":").concat(testFilePath) : testFilePath;
  var suiteTitles = test.titlePath().slice(0, -1);
  return (0, _reporter.md5)(JSON.stringify([testFileId, ...suiteTitles, getAllureDisplayName(test)]));
};
exports.getTestCaseId = getTestCaseId;
var getLegacyTestCaseId = test => {
  var testFilePath = test.file ? (0, _reporter.getPosixPath)((0, _reporter.getRelativePath)(test.file)) : "";
  var suiteTitles = test.titlePath().slice(0, -1);
  return (0, _reporter.md5)(JSON.stringify([testFilePath, ...suiteTitles, getAllureDisplayName(test)]));
};
exports.getLegacyTestCaseId = getLegacyTestCaseId;
